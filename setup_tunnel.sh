...
python3 -m venv venv && source venv/bin/activate && pip install fastapi uvicorn jinja2

echo "📁 Création de la structure du tunnel..."
mkdir -p NETSECURE_IA_TUNNEL/templates && touch NETSECURE_IA_TUNNEL/main.py NETSECURE_IA_TUNNEL/templates/cockpit.html NETSECURE_IA_TUNNEL/requirements.txt
